...
const CourseSummary = () => {
  ...
  const batches = [
    ...
    {
      id: "batch-2024-spring",
      name: "Spring 2024",
      occupiedSeats: 120,
      availableSeats: 30,
    },
    {
      id: "batch-2024-summer",
      name: "Summer 2024",
      occupiedSeats: 95,
      availableSeats: 55,
    },
      ...
      <div className="w-11/12 mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Overview of all courses, batches, and enrollment data
          </p>
        </div>
        {/* Summary Cards */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
          ...
          <StatCard
            ...
            subtitle={`${Math.round(
              (courseData.totalSeatsOccupied / courseData.totalAvailableSeats) *
                100
            )}% occupied`}
          ...
          <StatCard
            ...
            value={(
              courseData.totalAvailableSeats - courseData.totalSeatsOccupied
            ).toLocaleString()}
          ...
          {selectedBatch !== "all" && selectedBatchData && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <StatCard
                ...
                subtitle={`${Math.round(
                  (selectedBatchData.occupiedSeats /
                    (selectedBatchData.occupiedSeats +
                      selectedBatchData.availableSeats)) *
                    100
                )}% filled`}
                IconComponent={Armchair}
                color="#31918D"
